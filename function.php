...
function tambah_tamu($data)
{
    ...
    // ambil ID terakhir
    $result = mysqli_query($koneksi, "SELECT id_tamu FROM buku-tamu ORDER BY id_tamu DESC LIMIT 1");
...
function ubah_tamu($data)
{
    ...
    $query = "UPDATE buku_tamu SET nama_tamu= '$nama_tamu', alamat= '$alamat', no_hp= '$no_hp', bertemu='$bertemu', kepentingan= '$kepentingan', gambar = '$gambar' WHERE id_tamu ='$id'";
    mysqli_query($koneksi, $query);
    return mysqli_affected_rows($koneksi);
}
